...
public class Login extends JDialog {
	...
	public Login() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Сервер игры не запущен");
			e.printStackTrace();
		}
						...
						if (textLogin.getText().isEmpty()) {
							...
							if (passwd.isEmpty()) {
								...
								try {
									...
									JOptionPane.showInputDialog(this, "Сервер игры не запущен");
									e.printStackTrace();
									...
									JOptionPane.showMessageDialog(panel,
											"Сервер не отвечает или нет соединения с интернетом!");
